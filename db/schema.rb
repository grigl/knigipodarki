...
ActiveRecord::Schema.define(:version => 20130314081159) do
  ...
  create_table "pages", :force => true do |t|
    ...
    t.text     "payment_courier"
    t.text     "delivery_courier"
    t.text     "delivery_ems"
    t.text     "delivery_postamat"
    t.text     "delivery_pickup"
  ...
  create_table "payment_methods_shipping_methods", :id => false, :force => true do |t|
